...
define('CAMPAIGN_ID', "14b7aa32a0d8cbb9ae6a89d7c4efaab0");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', '16011043530ec68a687d205aebc97557');
define('MP_PARAM_NAME', '__rk__clk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'd61de26f4b83b194322cafba8b9786db');
define('CHECK_MCPROXY_VALUE', '22e330094acd1f7f3a81f1abdf632065c10a9b14bbd66ce1746f685d432f3d0d');
